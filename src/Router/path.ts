...
export const ROUTE_USER_PROFILE_AVATAR = ROUTE_USER_PROFILE + '/avatar'
export const ROUTE_USER_PROFILE_OTHER = ROUTE_USER_PROFILE + '/other'

export const WHITE_ROUTE_LIST = [ROUTE_ROOT, ROUTE_LOGIN, ROUTE_REGISTER, ROUTE_HOME]
